<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Manage Profile');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('Manage Details');?></h3>
                        </div>
						<?php
                        ...
                        ?>
                            ...
                            <div class="panel-footer text-right">
                                <span class="btn btn-info submitter" data-ing='<?php echo translate('updating..'); ?>' data-msg='<?php echo translate('profile updated!'); ?>'>
									<?php echo translate('Update Profile');?>
                                    	</span>
                            </div>
                        </form>

                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('Change Password');?></h3>
                        </div>
							<?php
                            ...
                            ?>
                                ...
                                <div class="panel-footer text-right">
                                    <span class="btn btn-info pass_chng disabled" disabled='disabled' data-ing='<?php echo translate('updating..'); ?>' data-msg='<?php echo translate('password_updated!'); ?>'>
                                    	<?php echo translate('Update Password');?>
                                    		</span>
                                </div>
                        	</form>
                        <?php
				...
				success: function(data) {
					...
					if (data == 'updated') {
						...
						$.picvotenoty({
							type: 'danger',
							icon: 'fa fa-check',
							message: '<?php echo translate('Incorrect Password!'); ?>',
							container: 'floating',
							timer: 3000
						});
					}
