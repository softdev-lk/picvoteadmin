...
<head>
	...
	<!--Stylesheet [ REQUIRED ]-->
	<link href="<?php echo base_url(); ?>template/back/css/picvote.min.css" rel="stylesheet">
	<!--Font Awesome [ OPTIONAL ]-->
	<link href="<?php echo base_url(); ?>template/back/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!--Demo [ DEMONSTRATION ]-->
<!--	<link href="--><?php //echo base_url(); ?><!--template/back/css/demo/picvote-demo.min.css" rel="stylesheet">-->
...
<body>
    ...
    style="background:url(<?php echo base_url(); ?>uploads/others/repeat.png) 50% 50% / auto repeat scroll;">
		<!-- BACKGROUND IMAGE -->
			...
			<div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 50px !important;">
				<div class="panel-body">
                	<a class="box-inline" href="<?php echo base_url(); ?>index.php/<?php echo $this->session->userdata('title'); ?>">
						<img src="<?php echo base_url(); ?>uploads/others/logonew.png" class="log_icon">
					</a>
                    <hr class="hr-log">
					<p class="pad-btm"><?php echo translate('Sign in');?></p>
					<?php
