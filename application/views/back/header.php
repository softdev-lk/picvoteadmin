<header id="navbar">
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="<?php echo base_url(); ?>index.php/<?php echo $this->session->userdata('title'); ?>"
               class="navbar-brand">

                <div class="brand-title">
                    <span class="brand-text">Picvote</span>
                </div>
            </a>
        </div>
        <!--End brand logo & name-->
        ...
        <div class="navbar-content clearfix">
            ...
            <ul class="nav navbar-top-links pull-right">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="<?php echo base_url(); ?>template/back/#" data-toggle="dropdown"
                       class="dropdown-toggle text-right">
                        <span class="pull-right">
                            ...
                            if ($this->session->userdata('title') == 'admin') {
                                ...
                                ?>
                                <img class="img-circle img-user media-object"
                                     src="<?php echo base_url(); ?>uploads/vendor/logo_<?php echo $this->session->userdata('vendor_id'); ?>.png"
                                     alt="Profile Picture">
                                <?php
                            }
                            ?>
